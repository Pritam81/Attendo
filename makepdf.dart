// ignore_for_file: camel_case_types, must_be_immutable, prefer_const_constructors, no_logic_in_create_state, prefer_typing_uninitialized_variables
        ...
        build: (context) {
          return pw.Column(
            ...
            children: [
              ...
              pw.Table(
                defaultColumnWidth: pw.FixedColumnWidth(1200.0),
                          ...
                          pw.Column(
                            children: [
                              pw.Text(
                                list[index],
                                textAlign: pw.TextAlign.center,
                                style: pw.TextStyle(fontSize: 13.0),
                              ),
                            ],
                          ),
                        ],
